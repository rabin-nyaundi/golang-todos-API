...
func main() {
	...
	flag.StringVar(&cfg.smtp.username, "smtp-username", "4a3f9cce8dbd7a", "SMTP Username")
	flag.StringVar(&cfg.smtp.password, "smtp-password", "9ba7b4fdec8796", "SMTP password")
	flag.StringVar(&cfg.smtp.sender, "smtp-sender", "TaskApp <no-reply@taskapp.net>", "SMTP sender")
